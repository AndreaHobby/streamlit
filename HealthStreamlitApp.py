...
sbp = st.selectbox('What is your systolic blood pressure? Normal: Below 120/80 Elevated: 120 to 129/less than 80. Stage 1 high blood pressure: 130 to 139/80 to 89. Stage 2 high blood pressure: 140 and above/90 and above. Hypertension crisis: above 180/above 120.', sbp_options)
...
Poor_Vision = st.selectbox('How is your vision?', poor_vision_options)
Smoker = st.selectbox('Do you smoke?', smoker_options)
...
CHF = st.selectbox('Do you have a history of heart disease?', chf_options)
